  ...
  async step(event) {
    ...
    if (document.getElementById("pokemon_step").value === 'bio') {
      ...
      if (data.html.includes("loading")) {
        ...
        "<div class='d-flex justify-content-center mt-2'><a href='/pokemons' class='text-decoration-none mt-2 mx-2'><button class='btn btn-primary text-white mt-2'>To Pokemon gallery</button></a><a href='/profile' class='text-decoration-none mt-2 mx-2'><button class='btn btn-primary text-white'>To your profile</button></a></div>"
        )
      }
    } else {
