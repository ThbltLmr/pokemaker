...
export default class extends Controller {
  ...
  async show(event) {
    ...
    if (this.element.classList.contains("home-profile")) {
      ...
      this.locationTarget.insertAdjacentHTML("beforeend", "<div class='d-flex justify-content-center mt-2'><button class='btn btn-primary' data-action='click->profile#reset'>Back</button></div>")
    }
  }
}
